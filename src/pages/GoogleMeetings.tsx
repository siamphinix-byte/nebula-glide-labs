...
const googleMeetings = [
  { id: 1, topic: 'Project Planning Session', desc: 'Planning session for upcoming project milestones', status: 'Scheduled', date: '2025-12-18', time: '14:00', duration: '60 minutes', project: 'Security Audit' },
  { id: 2, topic: 'Client Review Meeting', desc: 'Review meeting with client for project deliverabl...', status: 'Scheduled', date: '2025-12-19', time: '11:00', duration: '45 minutes', project: 'Performance Suite' },
  { id: 3, topic: 'Sprint Retrospective', desc: 'Sprint retrospective to discuss what went well an...', status: 'Scheduled', date: '2025-12-20', time: '16:00', duration: '60 minutes', project: 'Admin Dashboard' },
  { id: 4, topic: 'Technical Discussion', desc: 'Technical discussion about architecture and imp...', status: 'Scheduled', date: '2025-12-21', time: '10:30', duration: '90 minutes', project: 'Payment Integration' },
  { id: 5, topic: 'Monthly Business Review', desc: 'Monthly business review with stakeholders', status: 'Scheduled', date: '2025-12-23', time: '15:00', duration: '120 minutes', project: 'Cloud Migration' },
  { id: 6, topic: 'Training Session', desc: 'Training session on new tools and technologies', status: 'Scheduled', date: '2025-12-24', time: '13:00', duration: '75 minutes', project: 'Legacy Modernization' },
  { id: 7, topic: 'Product Demo', desc: 'Product demonstration for client feedback', status: 'Scheduled', date: '2025-12-26', time: '12:00', duration: '45 minutes', project: 'AI Chatbot' },
  { id: 8, topic: 'One-on-One Meeting', desc: 'One-on-one meeting for performance discussion', status: 'Scheduled', date: '2025-12-28', time: '17:00', duration: '30 minutes', project: 'Inventory System' },
  { id: 9, topic: 'Quarterly Planning', desc: 'Quarterly planning meeting for next quarter goals', status: 'Scheduled', date: '2025-12-30', time: '09:30', duration: '180 minutes', project: 'Mobile Banking App' },
];

export function GoogleMeetings() {
  return (
    <div className="max-w-[1400px] mx-auto space-y-6 pb-24 h-full">
      
      <Reveal direction="down">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <h1 className="text-3xl font-bold tracking-tight text-white">Google Meetings</h1>
        </div>
      </Reveal>
      ...
      <Reveal delay={0.1}>
         <div className="grid grid-cols-2 lg:grid-cols-4 border-b border-white/5 pb-6 gap-6 sm:gap-0 divide-y sm:divide-y-0 sm:divide-x divide-white/5">
            <div className="flex flex-col justify-center items-center text-center p-4">
               <span className="text-3xl font-black text-[#5b8cff] tracking-tight mb-2">9</span>
               <span className="text-[13px] font-bold text-white/50">Total Meetings</span>
            </div>
            <div className="flex flex-col justify-center items-center text-center p-4">
               <span className="text-3xl font-black text-[#bbf600] tracking-tight mb-2">9</span>
               <span className="text-[13px] font-bold text-white/50">Scheduled</span>
            </div>
            <div className="flex flex-col justify-center items-center text-center p-4">
               <span className="text-3xl font-black text-[#f1734f] tracking-tight mb-2">0</span>
      ...
      <Reveal delay={0.2}>
        <div className="bg-[#1c1b1b] rounded-2xl border border-white/5 shadow-2xl overflow-hidden mt-6">
           ...
           <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-6 bg-[#131313] border-t border-white/5 text-[13px] text-white/50">
             <span className="font-medium">Showing 1 to 9 of 9 meetings</span>
