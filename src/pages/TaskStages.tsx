...
import { Plus, GripVertical, Settings, CheckCircle, Pencil, Trash2 } from 'lucide-react';

const stages = [
  { id: 1, order: 1, name: 'To Do', color: '#ffb4ab', isDefault: true, count: 13 },
  { id: 2, order: 2, name: 'In Progress', color: '#bbf600', isDefault: false, count: 6 },
  { id: 3, order: 3, name: 'Review', color: '#d4bbff', isDefault: false, count: 16 },
  { id: 4, order: 4, name: 'Blocked', color: '#9fa9ff', isDefault: false, count: 11 },
  { id: 5, order: 5, name: 'Done', color: '#ffffff', isDefault: false, count: 26 },
];
    ...
    <div className="max-w-[1200px] mx-auto space-y-6 pb-24">
      ...
      <Reveal direction="down">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
          <h1 className="text-3xl font-bold tracking-tight text-white">Task Stages</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
           ...
           <div className="bg-[#1c1b1b] border border-white/5 p-6 rounded-2xl flex items-center justify-between group overflow-hidden relative">
              ...
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div>
                  <h4 className="text-[11px] font-bold uppercase tracking-widest text-white/50 mb-1">Total Stages</h4>
           ...
           <div className="bg-[#1c1b1b] border border-white/5 p-6 rounded-2xl flex items-center justify-between group overflow-hidden relative">
              ...
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div>
                  <h4 className="text-[11px] font-bold uppercase tracking-widest text-white/50 mb-1">Total Tasks</h4>
           ...
           <div className="bg-[#1c1b1b] border border-white/5 p-6 rounded-2xl flex items-center justify-between group overflow-hidden relative">
              ...
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div>
                  <h4 className="text-[11px] font-bold uppercase tracking-widest text-white/50 mb-1">Default Stage</h4>
                  <span className="text-2xl font-bold text-white">To Do</span>
                </div>
              </div>
           </div>
           ...
           <div className="bg-[#1c1b1b] border border-white/5 p-6 rounded-2xl flex items-center justify-between group overflow-hidden relative">
              ...
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div>
                  <h4 className="text-[11px] font-bold uppercase tracking-widest text-white/50 mb-1">Avg Tasks/Stage</h4>
      ...
      <Reveal delay={0.2}>
        <div className="mt-8">
          <div className="flex items-center gap-3 mb-4 pl-2">
            <h2 className="text-lg font-bold text-white">Workflow Stages</h2>
          ...
          <StaggerReveal className="space-y-3">
            {stages.map((stage) => (
              <div key={stage.id} className="group bg-[#1c1b1b] border border-white/5 hover:border-white/20 p-4 rounded-2xl flex items-center justify-between transition-all duration-300 cursor-grab active:cursor-grabbing hover:shadow-[0_5px_25px_rgba(0,0,0,0.5)]" draggable="true">
                 <div className="flex items-center gap-6 flex-1">
                    ...
                    <div className="flex items-center gap-3 min-w-[150px]">
                      <div className="w-3 h-3 rounded-full shadow-[0_0_10px_rgba(255,255,255,0.2)]" style={{ backgroundColor: stage.color }}></div>
                      <span className="font-bold text-white text-[15px]">{stage.name}</span>
                    </div>
                    {stage.isDefault && (
                 ...
                 <div className="flex items-center gap-8 pr-2">
                    <div className="text-center">
                      <span className="block text-lg font-bold text-white leading-none">{stage.count}</span>
                      <span className="text-[10px] text-white/40 font-medium">tasks</span>
                    </div>
